...
typeorm_1.createConnection().then(function (db) {
    ...
    var productRepository = typeorm_1.getMongoRepository(product_1.Product);
    amqp.connect("amqp://localhost", function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume("product_created", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var msg_product, eventProduct, product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            msg_product = JSON.stringify(msg === null || msg === void 0 ? void 0 : msg.content.toString());
                            eventProduct = JSON.parse(JSON.parse(msg_product));
            ...
            channel.consume("product_deleted", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var msg_product, admin_id;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            msg_product = JSON.stringify(msg === null || msg === void 0 ? void 0 : msg.content.toString());
                            admin_id = JSON.parse(JSON.parse(msg_product));
